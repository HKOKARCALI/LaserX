    ...
    void Update()
    {
        ...
        // Hit detection
        {
            ...
            if (foundHit)
            {
                ...
                if (closestHit.transform.tag == "ExplosiveBarrel")
                {
                    //Toggle "explode" on explosive barrel object
                    closestHit.transform.gameObject.GetComponent
                ...
                if (closestHit.transform.tag == "GasTank")
                {
                ...
                if (closestHit.transform.tag == "Target")
                {

...
public class EnemyController : MonoBehaviour
{
    ...
    void OnDie()
    {
       ...
       /* if (TryDropItem())
        ...
        if (score)
        {
            score.AddScore(100, Vector3.Distance(Vector3.zero, new Vector3(this.gameObject.transform.position.x, this.gameObject.transform.position.y, this.gameObject.transform.position.z)), 1);
        }
